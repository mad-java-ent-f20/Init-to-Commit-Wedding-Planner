...
class ContactDaoTest {
    ...
    void getById() {
        ...
        assertEquals("test1", retrievedContact.getMessage());
    }
    ...
    void getByPropertyEqual() {
        List<Contact> contact = genericDao.getByPropertyEqual("subject", "subject");
        assertEquals(3, contact.size());
        assertEquals(1, contact.get(0).getId());
    }
    ...
    void getByPropertyLike() {
        List<Contact> contact = genericDao.getByPropertyLike("subject", "s");
        assertEquals(3, contact.size());
    }
